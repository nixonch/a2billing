...
<p>Для получения ответа <u><b>о текущем балансе</b></u> в запрос вкладываются такие данные:</p>
...
<p>Для получения ответа <u><b>о стоимости звонка</b></u> в запрос вкладываются такие данные:</p>
<p1 style="color: #bf4f4c">u=&#123;Authorization name&#125;<br>
p=&#123;Password&#125;<br>
t=&#123;Number&#125;</p1>
<p>Ваша служба должна сформировать ответ в XML-формате в соответствии с таким шаблоном:</p>
...
<p1 style="color: #bf4f4c">https://my.web.com/request.php</p1>
<p1>Only supported method is POST at the moment.</p1><br>
<p>To receive an return response <u><b>about the current balance</b></u>, the following data contains into the request:</p>
<p1 style="color: #bf4f4c">u=&#123;Authorization name&#125;<br>
p=&#123;Password&#125;<br>
html=2</p1>
...
Respons named &lt;rereg&gt; is recomendation to do reregistration if needed.</p1><br>
<p>To receive an return response <u><b>about the call rate</b></u>, the following data contains into the request:</p>
<p1 style="color: #bf4f4c">u=&#123;Authorization name&#125;<br>
p=&#123;Password&#125;<br>
t=&#123;Number&#125;</p1>
