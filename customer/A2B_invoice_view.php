...
if(!$popup_select){
?>
<a href="javascript:;" onClick="alertBase('url:<?php echo $PHP_SELF ?>?popup_select=1&id=<?php echo $id ?>',null,true,false,'#666666')" > <img src="./templates/default/images/printer.png" title="Print" alt="Print" border="0"></a>
&nbsp;&nbsp;
<?php
} else {
?>
